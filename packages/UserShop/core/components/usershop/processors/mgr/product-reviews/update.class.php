...
class UserProductReviewsUpdateProcessor extends modObjectUpdateProcessor
{
    public $classKey = 'UserProductReviews'; // Указываем, с какой моделью работаем
...
return 'UserProductReviewsUpdateProcessor';
